...
{
	/* Nothing to do, too early in boot process to start the timer */
}

static int nru_timer_init(const struct device *unused)
{
...
SYS_INIT(nru_timer_init, APPLICATION, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT);
