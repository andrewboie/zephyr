...
#ifdef DEVICE_MMIO_IS_IN_RAM
/**
 * @def DEVICE_MMIO_RAM_PTR(_device)
 *
 ...
 */
#define DEVICE_MMIO_RAM_PTR(_device)	(mm_reg_t *)((_device)->driver_data)
#endif /* DEVICE_MMIO_IS_IN_RAM */
...
/**
 * @def DEVICE_MMIO_ROM_PTR(_device)
 *
...
#define DEVICE_MMIO_ROM_PTR(_device) \
	((struct z_device_mmio_rom *)((_device)->config_info))

/**
 * @def DEVICE_MMIO_ROM_INIT(_instance)
 *
...
/**
 * @def DEVICE_MMIO_MAP(_device, _flags)
 *
...
/**
 * @def DEVICE_MMIO_NAMED_RAM(_name)
 *
...
#ifdef DEVICE_MMIO_IS_IN_RAM
/**
 * @def DEVICE_MMIO_NAMED_RAM_PTR(_device, _name)
 *
...
/**
 * @def DEVICE_MMIO_NAMED_ROM(_name)
 *
 * @brief Declare storage for MMIO data within a device's config_info struct.
 *
...
/**
 * @def DEVICE_MMIO_NAMED_ROM_PTR(_device, _name)
 *
 * Return a pointer to the ROM-based storage area for a device's MMIO
 * information.
 *
...
/**
 * @def DEVICE_MMIO_NAMED_ROM_INIT(_name, _instance)
 *
...
/**
 * @def DEVICE_MMIO_NAMED_MAP(_device, _name, _flags)
 *
...
/**
 * @def DEVICE_MMIO_NAMED_GET(_device, _name)
 *
...
/**
 * @def DEVICE_MMIO_TOPLEVEL(_name, _instance)
 *
...
/**
 * @def DEVICE_MMIO_TOPLEVEL_DECLARE(_name)
 *
...
/**
 * @def  DEVICE_MMIO_TOPLEVEL_STATIC(_name, _instance)
 *
...
/**
 * @def DEVICE_MMIO_TOPLEVEL_MAP(_name, _flags)
 *
...
/**
 * @def DEVICE_MMIO_TOPLEVEL_GET(_name)
 *
