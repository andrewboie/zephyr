...
#ifdef CONFIG_MMU
/* Physcial addresses of page-aligned kernel image mapped into RAM at boot */
extern char z_mapped_phys_start[];
extern char z_mapped_phys_end[];
extern char z_mapped_phys_size[];
#endif /* CONFIG_MMU */
